...
extern "C"
{
  RegularExpressionValidator_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeRegularExpressionValidator()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeRegularExpressionValidator,&dl_info))
    {
  ...
  RegularExpressionValidator_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeRegularExpressionValidator()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeRegularExpressionValidator,&dl_info))
    {
