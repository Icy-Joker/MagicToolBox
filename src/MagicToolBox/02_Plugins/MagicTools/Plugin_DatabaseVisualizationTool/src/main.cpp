...
extern "C"
{
  DatabaseVisualizationTool_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeDatabaseVisualizationTool()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeDatabaseVisualizationTool,&dl_info))
    {
  ...
  DatabaseVisualizationTool_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeDatabaseVisualizationTool()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeDatabaseVisualizationTool,&dl_info))
    {
...
int main(int argc,char* argv[])
{
  ...
  DatabaseVisualizationTool main_window;
  main_window.show();
