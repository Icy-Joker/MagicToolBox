...
extern "C"
{
  GraphicsViewDemo_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeGraphicsViewDemo()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeGraphicsViewDemo,&dl_info))
    {
  ...
  GraphicsViewDemo_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeGraphicsViewDemo()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeGraphicsViewDemo,&dl_info))
    {
