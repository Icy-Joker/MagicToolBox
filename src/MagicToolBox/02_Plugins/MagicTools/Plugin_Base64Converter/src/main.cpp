...
extern "C"
{
  Base64Converter_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeBase64Converter()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeBase64Converter,&dl_info))
    {
  ...
  Base64Converter_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeBase64Converter()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeBase64Converter,&dl_info))
    {
