...
extern "C"
{
  XmlVisualEditor_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeXmlVisualEditor()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeXmlVisualEditor,&dl_info))
    {
  ...
  XmlVisualEditor_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeXmlVisualEditor()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeXmlVisualEditor,&dl_info))
    {
