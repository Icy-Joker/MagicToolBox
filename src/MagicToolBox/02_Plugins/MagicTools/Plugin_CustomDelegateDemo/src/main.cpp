...
extern "C"
{
  CustomDelegateDemo_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeCustomDelegateDemo()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeCustomDelegateDemo,&dl_info))
    {
  ...
  CustomDelegateDemo_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeCustomDelegateDemo()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeCustomDelegateDemo,&dl_info))
    {
...
int main(int argc,char* argv[])
{
  ...
  CustomDelegateDemo main_window;
  //main_window.show();
