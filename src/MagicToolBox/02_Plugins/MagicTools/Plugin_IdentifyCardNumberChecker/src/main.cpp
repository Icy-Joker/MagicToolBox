...
extern "C"
{
  IdentifyCardNumberChecker_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeIdentifyCardNumberChecker()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeIdentifyCardNumberChecker,&dl_info))
    {
  ...
  IdentifyCardNumberChecker_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeIdentifyCardNumberChecker()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeIdentifyCardNumberChecker,&dl_info))
    {
