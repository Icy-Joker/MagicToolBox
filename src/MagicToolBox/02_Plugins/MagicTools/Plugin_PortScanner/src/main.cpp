...
extern "C"
{
  PortScanner_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializePortScanner()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializePortScanner,&dl_info))
    {
  ...
  PortScanner_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizePortScanner()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizePortScanner,&dl_info))
    {
