...
extern "C"
{
  ChartDemo_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeChartDemo()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeChartDemo,&dl_info))
    {
  ...
  ChartDemo_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeChartDemo()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeChartDemo,&dl_info))
    {
