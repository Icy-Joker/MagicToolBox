...
extern "C"
{
  JsonVisualEditor_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeJsonVisualEditor()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeJsonVisualEditor,&dl_info))
    {
  ...
  JsonVisualEditor_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeJsonVisualEditor()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeJsonVisualEditor,&dl_info))
    {
