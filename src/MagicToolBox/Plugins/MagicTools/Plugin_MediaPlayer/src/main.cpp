...
extern "C"
{
  MediaPlayer_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeMediaPlayer()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeMediaPlayer,&dl_info))
    {
  ...
  MediaPlayer_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeMediaPlayer()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeMediaPlayer,&dl_info))
    {
