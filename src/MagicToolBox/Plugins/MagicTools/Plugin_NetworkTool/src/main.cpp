...
extern "C"
{
  NetworkTool_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeNetworkTool()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeNetworkTool,&dl_info))
    {
  ...
  NetworkTool_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeNetworkTool()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeNetworkTool,&dl_info))
    {
