...
extern "C"
{
  SerialPortDebugger_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeSerialPortDebugger()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeSerialPortDebugger,&dl_info))
    {
  ...
  SerialPortDebugger_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeSerialPortDebugger()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeSerialPortDebugger,&dl_info))
    {
