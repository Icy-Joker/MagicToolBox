...
extern "C"
{
  QRCodeGenerator_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeQRCodeGenerator()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeQRCodeGenerator,&dl_info))
    {
  ...
  QRCodeGenerator_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeQRCodeGenerator()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeQRCodeGenerator,&dl_info))
    {
